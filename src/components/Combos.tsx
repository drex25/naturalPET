      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white mb-4">
            Nuestros <span className="text-yellow-400">Combos</span>
          </h2>
          ...
          {combos.map((combo, index) => (
            <div
              ...
              className={`relative bg-gray-900 rounded-2xl p-6 border ${
                combo.popular ? 'border-yellow-400' : 'border-gray-800'
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4 border-t border-gray-800">
                  <p className="text-yellow-400 font-semibold text-lg mb-4">{combo.price}</p>
                  <a
                    href="https://wa.me/543764000000"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full inline-flex items-center justify-center px-4 py-3 bg-yellow-400 text-black font-semibold rounded-lg hover:bg-yellow-500 transition-colors duration-200"
                  >
