...
const Hero: React.FC = () => {
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 lg:pt-24 z-0">
      ...
      {/* Decorative Elements */}
      <div className="absolute top-20 left-10 w-16 sm:w-24 h-16 sm:h-24 border border-[#96BE11]/30 rounded-full animate-pulse"></div>
      ...
      <div className="absolute top-1/2 left-5 w-6 sm:w-8 h-6 sm:h-8 border border-[#96BE11]/20 rounded-full animate-pulse delay-500"></div>
