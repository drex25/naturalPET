          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 group">
                ...
                <span className="text-gray-400 text-sm group-hover:text-white transition-colors duration-300">Av. 45 nro 6865, Posadas</span>
              </div>
              <div className="flex items-center space-x-3 group">
                ...
                <span className="text-gray-400 text-sm group-hover:text-white transition-colors duration-300">+54 9 376 412-3456</span>
              </div>
              <div className="flex items-center space-x-3 group">
                <div className="w-10 h-10 bg-[#96BE11]/20 rounded-lg flex items-center justify-center group-hover:bg-[#96BE11]/30 transition-all duration-300">
                  <svg className="w-5 h-5 text-[#96BE11]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
