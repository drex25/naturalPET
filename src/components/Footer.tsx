          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <span className="text-gray-400 text-sm group-hover:text-white transition-colors duration-300">+54 9 376 451-8346</span>
              </div>
              <div className="flex items-center space-x-3 group">
                <div className="w-10 h-10 bg-[#96BE11]/20 rounded-lg flex items-center justify-center group-hover:bg-[#96BE11]/30 transition-all duration-300">
                  <svg className="w-5 h-5 text-[#96BE11]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-2 text-gray-400 text-sm">
              <span>Made by:</span>
              <a
                href="https://itsdrex.dev/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#96BE11] hover:text-[#EF9202] transition-colors duration-300 font-medium hover:underline"
              >
                itsdrex.dev
              </a>
            </div>
