        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:text-[#96BE11] hover:bg-gray-700 transition-colors duration-200"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#inicio" className="text-gray-400 hover:text-[#96BE11] transition-colors duration-200">
                  Inicio
                </a>
              </li>
              <li>
                <a href="#combos" className="text-gray-400 hover:text-[#96BE11] transition-colors duration-200">
                  Soluciones Nutricionales
                </a>
              </li>
              <li>
                <a href="#sobre-nosotros" className="text-gray-400 hover:text-[#96BE11] transition-colors duration-200">
                  Sobre Nosotros
                </a>
              </li>
              <li>
                <a href="#guia" className="text-gray-400 hover:text-[#96BE11] transition-colors duration-200">
                  Guía Práctica
                </a>
              </li>
              <li>
                <a href="#contacto" className="text-gray-400 hover:text-[#96BE11] transition-colors duration-200">
                  Contacto
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm">Av. 45 nro 6865, Posadas</span>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm">+54 9 376 412-3456</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-[#96BE11]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-gray-400 text-sm">Lun-Sáb: 7:30-12:30 / 15:30-19:30</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-gray-400 hover:text-[#96BE11] text-sm transition-colors duration-200">
                Política de Privacidad
              </a>
              <a href="#" className="text-gray-400 hover:text-[#EF9202] text-sm transition-colors duration-200">
